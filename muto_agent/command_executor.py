...
from muto_msgs.msg import CommandInput, CommandOutput, MutoAction, PluginResponse
from muto_msgs.srv import CommandPlugin

from .interfaces import CommandExecutor, BaseNode
from .exceptions import ServiceNotReadyError, CommandNotFoundError, ConfigurationError
...
class Command:
    ...
    def execute(self, method: str, payload: str, meta: Any, callback: Optional[Callable] = None) -> Optional[Future]:
        """
