...
class MQTTBroker:
    ...
    def _handle_mqtt_message(self, message: MQTTMessage) -> None:
        ...
        try:
            ...
            self.logger.info(f"Symphony router received MQTT message on topic: {topic}")
            ...
            try:
                ...
                error_response = COAResponse.bad_request(f"Invalid COARequest format: {e}")
            ...
            self._mqtt_manager.publish(response_topic, serialize_coa_response(coa_response))
