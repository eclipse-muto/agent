...
import unittest
import json
from agent.symphony.sdk.symphony_summary import (
    SummaryState,
    ComponentResultSpec,
    TargetResultSpec,
    SummaryResult,
...
from agent.symphony.sdk.symphony_types import State
...
class TestComponentResultSpec(unittest.TestCase):
    ...
    def test_component_result_spec_from_dict(self):
        ...
        data = {
            "status": State.DELETE_FAILED.value,
...
class TestTargetResultSpec(unittest.TestCase):
    ...
    def test_target_result_spec_from_dict(self):
        ...
        data = {
            ...
            "components": {
                "comp1": {
                    "status": State.UPDATE_FAILED.value,
